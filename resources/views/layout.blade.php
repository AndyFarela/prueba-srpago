...
<head>
	...
	<!-- nalika Icon CSS
		============================================ -->
    <link rel="stylesheet" href="/template/css/nalika-icon.css">
    <!-- owl.carousel CSS
		============================================ -->
...
<body>
    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a target="_blank" href="https://senorpago.com/index.php"><img class="main-logo" src="/template/img/logo.png" alt="" style="width: 10em;margin-top: 2em;"/></a>
                <strong><img src="/template/img/logo/logosn.png" alt="" /></strong>
            </div>
			<div class="nalika-profile">
				<div class="profile-dtl">
					<a href="#"><img src="/template/img/andy1.jpg" alt="" /></a>
					<h2>Andrea <span class="min-dtn">Farela</span></h2>
				</div>
            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            <a class="has-arrow" href="/" aria-expanded="false"><i class="icon nalika-home icon-wrap"></i> <span class="mini-click-non">Home</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Inbox" href="/"><span class="mini-sub-pro">Precios de gasolina</span></a></li>
                                <li><a title="View Mail" href="/import_excel"><span class="mini-sub-pro">Importar Excel</span></a></li>
                            </ul>
                        </li>
                        <li>
                            <a class="has-arrow" href="#" aria-expanded="false"><i class="icon nalika-diamond icon-wrap"></i> <span class="mini-click-non">Sobre mí</span></a>
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Peity Charts" href="/aboutme"><span class="mini-sub-pro">¡Mucho gusto!</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </nav>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="/"><img class="main-logo" src="/template/img/logo/logo.png" alt="" style="width: 13em;margin-top:1em;" /></a>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Home" href="#">Home <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                <li><a href="index.html">Precios gasolina</a></li>
                                                <li><a href="index-1.html">Importar Excel</a></li>
                                            </ul>
                                        </li>
                                        <li><a data-toggle="collapse" data-target="#aboutme" href="#">Sobre mí <span class="admin-project-icon nalika-icon nalika-down-arrow"></span></a>
                                            <ul id="demo" class="collapse dropdown-header-top">
                                                <li><a href="/aboutme">¡Mucho gusto!</a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        <div class="breadcomb-wp">
											<div class="breadcomb-ctn">
												...
												<p>agosto <span class="bread-ntd">2020</span></p>
											</div>
										</div>
                                    </div>
                                </div>
    ...
    <script src="/template/js/flot/curvedLines.js"></script>
    ...
    <script src="/template/js/consulta-precios.js"></script>
</body>
<!-- <script>
